...
export const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    subcategories: [
      ...
      { slug: 'mobile-pentest', name: '移动端渗透' },
      { slug: 'api-security', name: 'API 安全' },
      { slug: 'code-audit', name: '代码审计' },
      { slug: 'java-eco', name: 'Java 生态漏洞' },
      { slug: 'msf', name: 'Metasploit 基础' },
      { slug: 'cs', name: 'Cobalt Strike 基础' },
      { slug: 'internal', name: '内网渗透' },
      { slug: 'hardening', name: '安全加固' },
      { slug: 'emergency', name: '应急响应' },
      { slug: 'devices', name: '安全设备' },
      { slug: 'djb', name: '等级保护' },
